        ...
        <form class="questionblock" action="" method="post">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    $therapie = mysql_query("SELECT * FROM tblTherapieExperte WHERE Visite = $visite AND Experte = $experte");
                    while ($row = mysql_fetch_array($therapie)) {
//                            print_r($row);

                        $val = '';
                        if (isset($row['Therapie'])) {
                            $therapienArray = $row['IDTherapieExperte'];
...
//                        echo "<tr style=\"background-color:#b3e6ff;\">";
                    ...
                    <td style="text-align: right;">
                        <button type="submit" class="btn btn-danger btn-lg" name="loeschen[<?php echo $row['IDTherapieExperte'] ?>]" value="x">
